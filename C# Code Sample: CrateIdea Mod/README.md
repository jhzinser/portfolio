This is a Terraria mod, meant to interface with the game through tModLoader. Its purpose is to add additional item crates to the game, which are obtainable via fishing.
